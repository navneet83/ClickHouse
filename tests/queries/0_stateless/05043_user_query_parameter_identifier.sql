...
SET param_strict_user_05043 = 'user_05043_$';
SET enforce_strict_identifier_format = 1;
CREATE USER `user_05043_$`; -- { serverError BAD_ARGUMENTS }
CREATE USER {strict_user_05043:Identifier}; -- { serverError BAD_ARGUMENTS }
CREATE ROLE {strict_user_05043:Identifier}; -- { serverError BAD_ARGUMENTS }
GRANT SELECT ON *.* TO {strict_user_05043:Identifier}; -- { serverError BAD_ARGUMENTS }
DROP ROLE {strict_user_05043:Identifier}; -- { serverError BAD_ARGUMENTS }
